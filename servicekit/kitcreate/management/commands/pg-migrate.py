...
from kitcreate import models as kitcreate_models
from pricelists import models as pricelist_models
# from pricelists import models as pricelists_models
...
class Command(BaseCommand):
    ...
    kitcreate_models = [
        ...
        # kitcreate_models.Place,
        # kitcreate_models.EventData,
        
        # kitcreate_models.ServiceType,
        # kitcreate_models.ServiceLevel,

        # kitcreate_models.FormVersion,                
        # kitcreate_models.ServiceKitForm,
        # kitcreate_models.ServiceKit,

        # kitcreate_models.EventInfo,
        # kitcreate_models.EventSchedule,        

        # pricelist_models.Supplier,
        # pricelist_models.Product,
        # pricelist_models.Pricelist,
        # pricelist_models.Meta,
        # pricelist_models.PricelistGroup,
        # pricelist_models.Price,
        # pricelist_models.FormTemplate,
        # pricelist_models.PricelistLink,
    ]

    log_models = [LogEntry]

    # by default, migrate everything
    models_to_migrate = common_models + kitcreate_models + log_models
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('--kitcreate', action='store_true', default=False,
    ...
    def handle(self, *args, **options):
        ...
        if options['auth'] or options['kitcreate'] or options['logs']:
            self.models_to_migrate = []
            if options['auth']:
                self.models_to_migrate += self.common_models
            if options['kitcreate']:
                self.models_to_migrate += self.kitcreate_models
            if options['logs']:
    ...
    def summary(self):
        ...
        self.stdout.write("DATABASE WILL NEED TO BE RESYNCED, USE THE FOLLOWING COMMAND: python manage.py sqlsequencereset {{app_name}} | python manage.py dbshell")
